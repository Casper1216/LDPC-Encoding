...
void DSS(int v,int k,vector<int>& d1,vector<int>&d2){	//�إߤ@�� (v,k,2) �� DSS
	...
	while(d1.size()<k){
		...
		if(!is_DSS(d1,v)){			//�����ƼƦr or ���ODSS �R���í��s��Ʀr 
	...
	while(d2.size()<k){
		...
		if(!is_DSS_2(d2,diff,v)){		//�����ƼƦr or ���ODSS �R���í��s��Ʀr 
